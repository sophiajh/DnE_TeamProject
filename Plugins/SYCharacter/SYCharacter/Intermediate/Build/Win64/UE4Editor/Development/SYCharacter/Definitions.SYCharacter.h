#undef SYCHARACTER_API
#undef SYCHARACTER_VTABLE
...
#define UE_PROJECT_NAME Map_0130
...
#define SYCHARACTER_VTABLE DLLEXPORT_VTABLE
#define SYCHARACTER_API DLLEXPORT
